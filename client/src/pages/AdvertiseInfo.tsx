      ...
      <main className="min-h-screen">
        ...
        <section className="py-20 bg-slate-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {adZones.map((zone) => (
                <div key={zone.id} className="bg-white border border-slate-200 p-8">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex justify-between py-2">
                      ...
                      <span className="text-2xl font-heading text-sky-600">{zone.rate}</span>
                    </div>
                  </div>

                  <div className="bg-slate-100 h-32 flex items-center justify-center text-slate-500 border border-slate-200">
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              {[
                ...
                <div key={item.step} className="flex gap-6">
                  <div className="w-12 h-12 bg-sky-600 text-white rounded-full flex items-center justify-center shrink-0 font-heading text-xl">
                    {item.step}
                  </div>
                  <div>
        ...
        <section className="py-20 bg-sky-600 text-white">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-2xl mx-auto bg-white/10 backdrop-blur p-8 border border-white/20">
