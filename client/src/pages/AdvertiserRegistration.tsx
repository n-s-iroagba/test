...
export function AdvertiserRegistration() {
          ...
          <div className="container mx-auto px-4 max-w-2xl">
            <div className="bg-white border border-slate-200 p-12 text-center">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                ...
                <span className="font-semibold text-sky-600">pending verification</span>.
              </p>
  ...
  return (
    <>
      ...
      <main className="py-16 bg-slate-50 min-h-screen">
        <div className="container mx-auto px-4 max-w-2xl">
          <Link to="/advertise" className="inline-flex items-center gap-2 text-charcoal hover:text-sky-600 mb-8 font-semibold transition-colors">
