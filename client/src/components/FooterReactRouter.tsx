...
export function FooterReactRouter() {
  return (
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/news" className="text-slate-300 hover:text-sky-400 transition-colors">News & Updates</Link></li>
              <li><Link to="/fixtures" className="text-slate-300 hover:text-sky-400 transition-colors">Fixtures & Results</Link></li>
              <li><Link to="/academy" className="text-slate-300 hover:text-sky-400 transition-colors">Academy Program</Link></li>
              <li><Link to="/supporter-wall" className="text-slate-300 hover:text-sky-400 transition-colors">Supporter Wall</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/support" className="text-slate-300 hover:text-sky-400 transition-colors">Donate Now</Link></li>
              <li><Link to="/support" className="text-slate-300 hover:text-sky-400 transition-colors">Become a Patron</Link></li>
              <li><Link to="/advertise" className="text-slate-300 hover:text-sky-400 transition-colors">Advertise With Us</Link></li>
              <li><Link to="/pro-view" className="text-slate-300 hover:text-sky-400 transition-colors">Pro View Access</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-300">
          ...
          <div className="flex gap-6">
            <Link to="/help" className="hover:text-sky-400 transition-colors">Help & Contact</Link>
